...
public class ActivitiApplicationController {
    ...
    // 部署流程，根据bpmn文件，创建一个新的流程
    @RequestMapping(value = "/deploy")
    public void deploy() {
        securityUtil.logInAs("salaboy");
        String bpmnName = "MyProcess";
        DeploymentBuilder deploymentBuilder = repositoryService.createDeployment().name("请假流程");
        Deployment deployment = deploymentBuilder.addClasspathResource("processes/" + bpmnName + ".bpmn")//添加bpmn资源
    ...
    // 查看流程
    @RequestMapping(value = "/queryDeploy")
     ...
     * 历史活动实例查询,参数也能查到
     */
    @RequestMapping(value = "/queryHistoryTask")
