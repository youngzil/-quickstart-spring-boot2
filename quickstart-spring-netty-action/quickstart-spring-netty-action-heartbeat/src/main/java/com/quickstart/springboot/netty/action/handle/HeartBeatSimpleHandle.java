package com.quickstart.springboot.netty.action.handle;
 ...
 * Function:
 *
 * @author crossoverJie Date: 17/05/2018 18:52
 * @since JDK 1.8
 */
public class HeartBeatSimpleHandle extends SimpleChannelInboundHandler<CustomProtocol> {
  ...
  private static final ByteBuf HEART_BEAT = Unpooled
      .unreleasableBuffer(Unpooled.copiedBuffer(new CustomProtocol(123456L, "pong").toString(), CharsetUtil.UTF_8));
